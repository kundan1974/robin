...
def fig02(records_df):
    ...
    fig = px.bar(new_df, y='Name', x=['Done Fractions', 'Phase1 Fractions', 'Planned Fractions'], height=350,
                 width=600,
...
app = DjangoDash('rt_status', external_stylesheets=external_stylesheets)
# fig = fig01(get_df())
app.layout = html.Div([
    html.Div(
